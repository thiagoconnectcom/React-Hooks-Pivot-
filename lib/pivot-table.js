...
module.exports = createReactClass({
    ...
    if (dimensionExists) {
      var solo = (
        <span className="reactPivot-solo">
          <button
            className="cursor-pointer buttonSolo"
  ...
  paginate: function(results) {
    ...
    if (!nPaginateRows || !isFinite(nPaginateRows))
      nPaginateRows = results.length;
